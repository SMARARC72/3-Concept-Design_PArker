        ...
        {!isSuccess ? (
          <>
            ...
            <div className="mt-8 text-center">
              <Link
                to="/auth/login"
                className="inline-flex items-center text-sm text-pj-blue hover:text-pj-navy font-medium transition-colors"
              >
          ...
          <div className="success-content text-center py-8">
            ...
            <p className="text-pj-gray mb-2">
              We&apos;ve sent password reset instructions to:
            </p>

            <p className="text-pj-navy font-medium mb-6">{getValues('email')}</p>

            <p className="text-sm text-pj-gray mb-8">
